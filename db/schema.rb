...
ActiveRecord::Schema.define(version: 2021_12_01_161125) do
  ...
  create_table "collection_restaurants", force: :cascade do |t|
    t.bigint "restaurant_id", null: false
    t.bigint "collection_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["collection_id"], name: "index_collection_restaurants_on_collection_id"
    t.index ["restaurant_id"], name: "index_collection_restaurants_on_restaurant_id"
  end
